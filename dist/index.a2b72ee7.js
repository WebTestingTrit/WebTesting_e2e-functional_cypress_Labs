...
})({"5xF5s":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "c142a36ea2b72ee7";
...
},{}],"kUE82":[function(require,module,exports) {
/* eslint-disable max-params */ /* eslint-disable @typescript-eslint/explicit-function-return-type */ /* eslint-disable max-lines-per-function */ var _api = require("./api");
...
function bindEventsOfIncompletedTaskElements() {
    for(let i = 0; i < incompleteTasksHolder.children.length; i++)bindEventsOfTaskElements(incompleteTasksHolder.children[i], markTaskCompleted);
}
function bindEventsOfCompletedTaskElements() {
    for(let i = 0; i < completedTasksHolder.children.length; i++)bindEventsOfTaskElements(completedTasksHolder.children[i], markTaskIncomplete);
}
function addTask() {
    ...
    taskInput.value = "";
    (0, _api.postTask)(newTask).then((task)=>appendTaskElement(task));
}
...
function editTask() {
    ...
    if (isInEditMode) saveEditedTask(taskListItem, descriptionInput, descriptionLabel);
    else prepareTaskForEdition(descriptionInput, descriptionLabel);
...
function saveEditedTask(taskListItem, descriptionInput, descriptionLabel) {
    ...
    (0, _api.putTask)(editedTask).then(()=>{
...
function removeTask() {
    ...
    const taskListItem = this.parentNode;
    (0, _api.deleteTask)(taskListItem.id).then(()=>{
...
},{"./api":"eYU08"}],"eYU08":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAllTasks", ()=>getAllTasks);
parcelHelpers.export(exports, "getTask", ()=>getTask);
parcelHelpers.export(exports, "postTask", ()=>postTask);
parcelHelpers.export(exports, "putTask", ()=>putTask);
...
},{}]},["5xF5s","kUE82"], "kUE82", "parcelRequire52cd")

//# sourceMappingURL=index.a2b72ee7.js.map
